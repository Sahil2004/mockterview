...
import { FiMic, FiMicOff, FiClock, FiSend, FiHelpCircle, FiAward, FiMaximize2, FiX } from "react-icons/fi";
...
const Interview = () => {
  ...
  if (!browserSupportsSpeechRecognition) {
    return <div className="text-red-500 p-4">Browser doesn't support speech recognition.</div>;
  }
      ...
      <div className="flex justify-between items-center p-4 bg-gray-800/50 backdrop-blur-sm">
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="text-indigo-300 font-medium">{formatTime(timeLeft)}</span>
          </motion.div>
              ...
              <div className="flex justify-start">
                <div className="bg-gray-700/50 p-4 rounded-2xl max-w-[80%]">
                  <p className="text-gray-300">
                    Welcome! I'm your AI interviewer. Let's discuss your approach.
                  </p>
                </div>
              </div>
